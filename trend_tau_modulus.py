...
ds = xr.open_dataset(surf_path+'/Results/'+variable+'_ORCA-0.25x0.25_regular_1979_2018.nc')
lat = ds.lat
lon = ds.lon
time = ds.time
var = ds[variable] 
...
trend_matrix.to_netcdf(surf_path+'/Results/'+'trend_'+variable+'_ORCA-0.25x0.25_regular_1979_2018.nc')
trend_pvalue.to_netcdf(surf_path+'/Results/'+'pvalue_'+variable+'_ORCA-0.25x0.25_regular_1979_2018.nc')
